# If you need to connect to Azure account, uncomment the comment below
# Connect-AzAccount
# The SubscriptionId in which to create these objects
# To get your SubscriptionId, use this command: Get-AzSubscription
$SubscriptionId = '' 
# Set the resource group name and location for your source server
$sourceResourceGroupName = "mySourceResourceGroup-$(Get-Random)"
$sourceResourceGroupLocation = "westeurope"
# Set the resource group name and location for your target server
$targetResourceGroupname = "myTargetResourceGroup-$(Get-Random)"
$targetResourceGroupLocation = "northeurope"
...
$targetDatabaseName = "CopyOfSampleDatabase"
...
#  Get required information to connect to server
Write-Host $sourceServerName'.database.windows.net'
Write-Host $targetDatabaseName'.database.windows.net'
$adminSqlLogin
$password